        ...
        <div class="flex justify-between items-center h-16">
          ...
          <div class="hidden md:flex items-center gap-8">
            <a routerLink="/" 
               ...
               class="text-slate-300 hover:text-white hover:scale-105 transition-all duration-300">Home</a>
            ...
            <a routerLink="/ai-recommendations" class="text-slate-300 hover:text-white hover:scale-105 transition-all duration-300">AI Recommendations</a>
            <!-- ADMIN links -->
