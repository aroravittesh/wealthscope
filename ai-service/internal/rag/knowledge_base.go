...
var KnowledgeBase = []FinancialDocument{
    ...
    },
    {
        ID:    "5",
        Topic: "pe_ratio",
        Content: `The Price-to-Earnings ratio measures a company's current share price
    ...
    },
    {
        ...
        Large cap companies have market caps over 10 billion dollars.
        Mid cap companies range from 2 billion to 10 billion dollars.
        Small cap companies have market caps under 2 billion dollars.
    ...
    },
    {
        ...
        future price movements. Common indicators include moving averages, RSI,
        MACD, and Bollinger Bands. Technical analysts believe past
