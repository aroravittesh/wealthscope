...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, AiRecommendationsComponent],
...
export class DashboardOverviewComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // Set mock metrics so skeletons disappear immediately
    this.metrics = {
      totalValue: 12700.50,
      totalInvested: 10000.00,
      totalProfitLoss: 2700.50,
      profitLossPercentage: 27.0,
      assetsCount: 12,
      topPerformers: []
